...
<img src="https://latex.codecogs.com/svg.latex?\large&space;Translation\:in\:y\:\:\left&space;(&space;t_{y}&space;\right&space;)=1.011\:m" title="\large Translation\:in\:y\:\:\left ( t_{y} \right )=1.011\:m" />
